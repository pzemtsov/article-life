...
final class Hash6 extends Worker
{
    ...
    private final ArrayList<Entry<LongPoint, Value>> toReset = new ArrayList<Entry<LongPoint, Value>> ();
    private final ArrayList<Entry<LongPoint, Value>> toSet = new ArrayList<Entry<LongPoint, Value>> ();
    
    public Hash6 (LongPoint.Factory factory)
    {
