...
final class Hash8 extends Worker
{
    public static final int HASH_SIZE = 256*1024;

    private final LongPoint.Factory factory;
    private LinkedHashMap<LongPoint, Value> field = new LinkedHashMap<LongPoint, Value> (HASH_SIZE);
    private Entry<LongPoint, Value> [] toReset = new Entry [128];
    private Entry<LongPoint, Value> [] toSet = new Entry [128];
    
    public Hash8 (LongPoint.Factory factory)
    {
